/*
 * @(#) CProvRecordFour.java       1.1 19/8/2016
 *
...
/**
 * A provenance graph to validate against the following policy: If a file
 * (fileA) is labelled as ‘general’, any user (UserA) can share the file with
 * other users (UserX)
 * 
