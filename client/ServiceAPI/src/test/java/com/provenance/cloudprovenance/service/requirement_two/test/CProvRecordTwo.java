...
public class CProvRecordTwo {
	...
	public CProvRecordTwo(ServiceXmlDocumentTraceability<String> cProvApi) {
	...
	public void genPreStatements() {
		...
		String cprocess2Id = cProvApi.cProcess("referenceGen",
				"http://127.0.0.1/bob", "http://127.0.0.1/bob/Linux/vProcess2",
				"127.0.0.1/Linux/pProcess2ref", null);
		...
		// outcome
		String cres3Id = cProvApi.cResource("fileAref", "data",
				"http:127.0.0.1/bob@yahoo.com",
				"http://127.0.0.1/bob/res/fileA1", "127.0.0.1", true, null,
				null, "confidential", 1.0f, null);
