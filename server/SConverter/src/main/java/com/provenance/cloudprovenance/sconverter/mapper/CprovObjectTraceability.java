...
public class CprovObjectTraceability implements
	...
	@Override
	public synchronized Transition transition(String id, String state,
	...
	public synchronized HadOwnership hadOwnership(String id, String resource,
		...
		QName ownershipId = new QName(
				ServiceTraceability.UNIQUE_IDENTIFIER_NS_PROVD_SUFFIX,
				ownershipType,
				ServiceTraceability.UNIQUE_IDENTIFIER_NS_PROVD_PREFIX);
