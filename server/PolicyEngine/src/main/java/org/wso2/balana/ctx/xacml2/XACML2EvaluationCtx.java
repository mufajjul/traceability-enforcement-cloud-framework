...
public class XACML2EvaluationCtx extends BasicEvaluationCtx {
	...
	private static Logger logger = Logger.getLogger(XACML2EvaluationCtx.class);
	...
	/**
	 * Override to add support for the provenance Store
	 * @param requestCtx
	 * @param pdpConfig
	 * @param serviceId
	 * @throws ParsingException
	 */
	public XACML2EvaluationCtx(RequestCtx requestCtx, PDPConfig pdpConfig, String serviceId)
			throws ParsingException {
